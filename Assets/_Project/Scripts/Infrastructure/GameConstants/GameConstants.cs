namespace _Project.Scripts.Infrastructure.GameConstants
{
    public static class GameConstants
    {
        ...
        public const string CASTLE_HEALTH_MODEL_INJECT_ID = "CastleHealthModel";
        public const string HUD_INJECT_ID = "HUD";
    }
}